...
#include <stdio.h>
void get_array(double arr[][5], int);
double get_five_average(double *arr, int cols);
double get_avg(double arr[][5], int);
double get_max(double arr[][5], int);
...
void get_array(double arr[][5], int rows)
{
...
double get_avg(double arr[][5], int rows)
{
    double sum = 0;
    for (int i = 0; i < rows; i++)
    {
