...
void get_year_average(const float rain[][MONTHS], int rows);
void get_month_average(const float rain[][MONTHS], int rows);
...
int main(void)
{
    ...
    get_year_average(rain, YEARS);
    get_month_average(rain, YEARS);
    return 0;
}
